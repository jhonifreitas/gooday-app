...
class BettyConfigScreen extends StatefulWidget {
  const BettyConfigScreen({super.key});

  @override
  State<BettyConfigScreen> createState() => _BettyConfigScreenState();
}

class _BettyConfigScreenState extends State<BettyConfigScreen> {
  bool _hint = false;
